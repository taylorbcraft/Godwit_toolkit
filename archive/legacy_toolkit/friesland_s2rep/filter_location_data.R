...
swf <- read_sf('Friesland_S2REP_App/parcel_geometry/LUI_SWF_2016_WGS84.shp')
locations <- readRDS('Friesland_S2REP_App/allLocations.rds')
locations <- locations %>%
...
saveRDS(locations_clipped,'Friesland_S2REP_App/locations_swf.rds')
